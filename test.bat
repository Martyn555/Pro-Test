...
set computernamee=%computernamec:ê=e%
set computernamel=%computernamee:³=l%
set computernamen=%computernamel:ñ=n%
set computernameo=%computernamen:ó=o%
set computernames=%computernameo:œ=s%
set computernamez=%computernames:¿=z%
set computernamepo=%computernamez:Ÿ=z%

set usernamea=%username:¹=a%
set usernamec=%usernamea:æ=c%
set usernamee=%usernamec:ê=e%
set usernamel=%usernamee:³=l%
set usernamen=%usernamel:ñ=n%
set usernameo=%usernamen:ó=o%
set usernames=%usernameo:œ=s%
set usernamez=%usernames:¿=z%
set usernamepo=%usernamez:Ÿ=z%

set urdiscordnicka=%urdiscordnick:¹=a%
set urdiscordnickc=%urdiscordnicka:æ=c%
set urdiscordnicke=%urdiscordnickc:ê=e%
set urdiscordnickl=%urdiscordnicke:³=l%
set urdiscordnickn=%urdiscordnickl:ñ=n%
set urdiscordnicko=%urdiscordnickn:ó=o%
set urdiscordnicks=%urdiscordnicko:œ=s%
set urdiscordnickz=%urdiscordnicks:¿=z%
set urdiscordnickpo=%urdiscordnickz:Ÿ=z%

set urmessagediscorda=%urmessagediscord:¹=a%
set urmessagediscordc=%urmessagediscorda:æ=c%
set urmessagediscorde=%urmessagediscordc:ê=e%
set urmessagediscordl=%urmessagediscorde:³=l%
set urmessagediscordn=%urmessagediscordl:ñ=n%
set urmessagediscordo=%urmessagediscordn:ó=o%
set urmessagediscords=%urmessagediscordo:œ=s%
